...
@:meta(SWF(width="1920", height="1080", backgroundColor="#000000", frameRate="60"))
    class DungeonBustersProject extends GameEntry
   {
      ...
      #if cpp
      function applyFrameRateFromArguments(param1:Array<String>) : String
      {
         var _loc1_:String = null;
         var _loc2_:String = null;
         var _loc3_= 0;
         ...
         {
            return "Ignoring " + FRAME_RATE_ARGUMENT + " outside the supported range of " + MIN_FRAME_RATE + " to " + MAX_FRAME_RATE + ": " + _loc2_;
         }
